...
/***/ function(module, exports, __webpack_require__) {
	...
	var jQuery = __webpack_require__(104);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(128);
	__webpack_require__(130);
	// import our application router
	var Workspace = __webpack_require__(134);
	// import FastClick, to improve UI responsiveness on mobile
	var FastClick = __webpack_require__(151);
	// and last but not least, import our AppView
	var LookBookView = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(129), __webpack_require__(104), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @see https://github.com/azproduction/rivets-backbone-adapter
	(function (root, factory) {
	    'use strict';
	    if (true) {
	        // CommonJS
	        factory(__webpack_require__(131), __webpack_require__(128));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  if (typeof (typeof module !== "undefined" && module !== null ? module.exports : void 0) === 'object') {
	    module.exports = Rivets.factory(__webpack_require__(133));
	  } else if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(133)], __WEBPACK_AMD_DEFINE_RESULT__ = function(sightglass) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(104);
	var Backbone = __webpack_require__(128);
	var Navstack = __webpack_require__(135);
	var DepartmentPaneView = __webpack_require__(136);
	var DepartmentsPaneView = __webpack_require__(144);
	var SearchPaneView = __webpack_require__(147);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/* jshint es3: true, expr: true */
	/* globals define */
	/*
	 * Navstack
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasePaneView = __webpack_require__(137);
	var BackNavbarView = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(128);
	var BaseView = __webpack_require__(138);
	var rivets = __webpack_require__(131);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BootstrapNavbarView = __webpack_require__(140);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(128);
	var BaseView = __webpack_require__(138);
	var baseNavbarTemplate = __webpack_require__(141);
	var rivets = __webpack_require__(131);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container-fluid\">\n  <!-- Brand and toggle get grouped for better mobile display -->\n  <div class=\"navbar-header pull-left\">\n    <a class=\"navbar-brand\" href=\"#\" data-action=\"toggle-left-side-menu\">LookBook</a>\n  </div>\n\n  <a href=\"route:search\" class=\"btn btn-link btn-lg pull-right\"><span class=\"glyphicon glyphicon-search\"></span></a>\n\n</div><!-- /.container-fluid -->"

/***/ },
/* 142 */
/***/ function(module, exports) {

	module.exports = "<div class=\"container-fluid\">\n\n\t<span class=\"navbar-title\" rv-text=\"parent.title\"></span>\n\n  <a href=\"route:back\" class=\"btn btn-link btn-lg pull-left\"><span class=\"glyphicon glyphicon-chevron-left\"></span></a>\n\n</div><!-- /.container-fluid -->"

/***/ },
/* 143 */
/***/ function(module, exports) {

	module.exports = "<div class=\"container\">\n\n\t<div class=\"row\">\n\n\t\t<div class=\"col-xs-12\">\n\n\t\t\t<h1 class=\"department-name list-group-heading\"><%= department.get('name') %></h1>\n\t\t\t<ul class=\"people\">\n\t\t\t\t<% _.each(department.people(), function(person) { %>\n\t\t\t\t\t<li class=\"person\">\n\t\t\t\t\t\t<a href=\"route:people/<%= person.cid %>\" title=\"<%= person.get('name') %>\" style=\"background-image:url('<%= person.get('img') %>');\"></a>\n\t\t\t\t\t</li>\n\t\t\t\t<% }) %>\n\t\t\t</ul>\n\n\t\t</div>\n\n\t</div>\n\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasePaneView = __webpack_require__(137);
	var BootstrapNavBar = __webpack_require__(140);
	var Departments = __webpack_require__(145);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container\">\n\t<div class=\"row\">\n\t\t<div class=\"col-xs-12\">\n\t\t\t<h1 class=\"list-group-heading\">Departments</h1>\n\t\t\t<div class=\"list-group\">\n\t\t\t <% _.each(departments.where({ 'parent': undefined }), function(department) { %>\n\t\t\t \t<a class=\"list-group-item\" href=\"route:departments/<%= department.cid %>\">\n\t\t\t \t\t<span class=\"media-body\">\n\t\t\t \t\t\t<%= department.get('name') %>\n\t\t\t \t\t</span>\n\t\t\t \t\t<span class=\"media-right\">\n\t\t\t \t\t\t<i class=\"fa fa-chevron-right\"></i>\n\t\t\t \t\t</span>\n\t\t\t \t</a>\n\t\t\t \t<% _.each(departments.where({ 'parent': department.cid }), function(department) { %>\n\t\t\t \t\t<a class=\"list-group-item child-department\" href=\"route:departments/<%= department.cid %>\">\n\t\t\t\t \t\t<span class=\"media-body\">\n\t\t\t\t \t\t\t&mdash;&nbsp;<%= department.get('name') %>\n\t\t\t\t \t\t</span>\n\t\t\t\t \t\t<span class=\"media-right\">\n\t\t\t\t \t\t\t<i class=\"fa fa-chevron-right\"></i>\n\t\t\t\t \t\t</span>\n\t\t\t\t \t</a>\n\t\t\t \t<% }) %>\n\t\t\t <% }) %>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasePaneView = __webpack_require__(137);
	var SearchNavbarView = __webpack_require__(148);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container-fluid\">\n\n\t<div class=\"navbar-form navbar-form-search\">\n\t\t<div class=\"media\">\n\t    <div class=\"media-body\">\n\t      <div class=\"input-group\">\n\t        <span class=\"input-group-addon\">\n\t          <i class=\"fa fa-search\"></i>\n\t          <i class=\"fa fa-clock-o\" style=\"display:none;\"></i>\n\t        </span>\n\t        <input type=\"search\" name=\"search\" class=\"form-control input-search\" placeholder=\"Search\" data-value=\"search\" autocapitalize=\"none\">\n\t      </div>\n\t    </div>\n\t    <div class=\"media-right\">\n\t      <a href=\"route:/\" class=\"btn btn-link\">Cancel</a>\n\t    </div>\n\t  </div>\n\t</div>\n\n</div><!-- /.container-fluid -->"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppView = __webpack_require__(153);
	var People = __webpack_require__(159);
	...
	var LookBookView = AppView.extend({
		...
		initialize: function() {
			...
			this.people.reset(__webpack_require__(160));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(104);
	var Backbone = __webpack_require__(128);
	var User = __webpack_require__(154);
	var AuthModalView = __webpack_require__(155);
	var rivets = __webpack_require__(131);
	var Navstack = __webpack_require__(135);
	var Workspace = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rivets = __webpack_require__(131);
	var Backbone = __webpack_require__(128);
	var BootstrapModalView = __webpack_require__(156);
	var authModalTemplate = __webpack_require__(158);
	var User = __webpack_require__(154);
	var $ = __webpack_require__(104);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(128);
	var BaseView = __webpack_require__(138);
	var baseModalTemplate = __webpack_require__(157);
...
/***/ function(module, exports) {
	...
	module.exports = "<form class=\"modal-dialog modal-dialog-auth\" novalidate>\n  <input type=\"hidden\" name=\"action\" value=\"signin\">\n  <ul class=\"nav nav-tabs\" role=\"tablist\">\n    <li role=\"presentation\" class=\"active\"><a href=\"#signin\" aria-controls=\"home\" role=\"tab\" data-toggle=\"tab\">Sign In</a></li>\n    <li role=\"presentation\"><a href=\"#signup\" aria-controls=\"profile\" role=\"tab\" data-toggle=\"tab\">Sign Up</a></li>\n    <li role=\"presentation\" class=\"pull-right\"><a href=\"#reset\" aria-controls=\"settings\" role=\"tab\" data-toggle=\"tab\">Reset</a></li>\n  </ul>\n  <div class=\"form-group\">\n    <input type=\"email\" rv-value=\"model:email\" class=\"form-control input-lg\" placeholder=\"E-mail\">\n  </div>\n  <div class=\"form-group\" rv-hide=\"model:isResetMode\">\n    <input type=\"password\" rv-value=\"model:password\" class=\"form-control input-lg\" placeholder=\"Password\" value=\"\">\n  </div>\n  <div class=\"form-group\" rv-show=\"model:isSignUpMode\">\n    <input type=\"password\" class=\"form-control input-lg\" rv-value=\"model:password_confirmation\" placeholder=\"Repeat password\" value=\"\">\n  </div>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block\" rv-show=\"model:isSignInMode\" data-loading-text=\"Signing you in...\">Sign In</button>\n    <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block\" rv-show=\"model:isSignUpMode\" data-loading-text=\"Signing up...\">Sign Up</button>\n    <button type=\"submit\" class=\"btn btn-primary btn-lg btn-block\" rv-show=\"model:isResetMode\" data-loading-text=\"Sending reset e-mail...\">Reset password</button>\n  </div>\n  <div class=\"alert\" style=\"display:none;\"></div>\n  <div class=\"arrow-up\"></div>\n</form><!-- /.modal-dialog -->"

/***/ },
/* 159 */
/***/ function(module, exports, __webpack_require__) {

	var people = __webpack_require__(160);
	...
	module.exports = [
		{
			...
			"vacation": "Tibet, Zen Buddhist Retreat",
			"challenge": "Shipping a native mobile application",
			"departments": [
				{
					"name": "Regional and B2B Marketing",
					"children": [
						{
							"name": "Europe"
						}
		...
		{
			"name": "Brian Helton",
			"img": "https://s3.amazonaws.com/uifaces/faces/twitter/dustin/128.jpg",
			"title": "President",
			"book": "Diary of Wimpy Kid",
			"challenge": "Getting out of bed tomorrow",
			"departments": [
				{
